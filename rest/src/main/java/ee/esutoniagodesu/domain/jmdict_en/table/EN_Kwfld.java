...
@Entity
@Immutable
@Table(name = "kwfld", schema = "jmdict_en", catalog = "egd")
public final class EN_Kwfld implements Serializable {

    private static final long serialVersionUID = 3824214307195329456L;
    private short id;
    private String kw;
    private String descr;
    private Collection<EN_Fld> fldsById;
    ...
    public Collection<EN_Fld> getFldsById() {
        return fldsById;
    }

    public void setFldsById(Collection<EN_Fld> fldsById) {
