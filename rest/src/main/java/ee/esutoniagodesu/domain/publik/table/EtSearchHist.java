...
@Table(name = "et_search_hist", schema = "public", catalog = "egd")
@Entity
public final class EtSearchHist implements Serializable {

    private static final long serialVersionUID = 3429813237987717792L;
    ...
    @SequenceGenerator(name = "seq", sequenceName = "public.et_search_hist_id_seq", allocationSize = 1)
    ...
    public boolean equals(Object o) {
        ...
        EtSearchHist that = (EtSearchHist) o;
