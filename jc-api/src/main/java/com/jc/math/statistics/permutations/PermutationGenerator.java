...
public final class PermutationGenerator {
	...
	/**
	 * @return Return number of permutations not yet generated
	 */
	...
	/**
	 * @return Return total number of permutations
	 */
	...
	/**
	 * @return Generate next permutation (algorithm from Rosen p. 284)
	 */
	public int[] getNext() {
