...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'main/webapp/bower_components/hwcrypto/hwcrypto.js',
            ...
            'main/webapp/bower_components/qtip2/jquery.qtip.js',
            'main/webapp/bower_components/qtip2/basic/jquery.qtip.js',
