...
import ee.esutoniagodesu.domain.jmdict_en.pk.EN_RadPK;
...
@Entity
@Immutable
@Table(name = "rad", schema = "jmdict_en", catalog = "egd")
@IdClass(EN_RadPK.class)
public final class EN_Rad implements Serializable {
