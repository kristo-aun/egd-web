...
@Entity
@Immutable
@Table(name = "ssum", schema = "jmdict", catalog = "egd")
public final class Ssum implements Serializable {

    private static final long serialVersionUID = -6850296812908304429L;
