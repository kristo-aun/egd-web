...
import ee.esutoniagodesu.domain.jmdict.pk.RdngsndPK;
...
@Table(name = "Rdngsnd", schema = "jmdict", catalog = "egd")
public final class Rdngsnd implements Serializable {

    private static final long serialVersionUID = -2668767485916152400L;
    private int entr;
    private int rdng;
    private int ord;
    private int snd;
