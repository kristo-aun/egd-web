...
public class TestCompoundResource {
    ...
    @RequestMapping(value = "/rest/test/compound/params",
    ...
    @RequestMapping(value = "/rest/test/compound/form-default/{defaultId}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @RolesAllowed(AuthoritiesConstants.USER)
    ...
    @RequestMapping(value = "/rest/test/compound/submit",
