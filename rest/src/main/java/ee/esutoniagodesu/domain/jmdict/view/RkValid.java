...
@Entity
@Immutable
@Table(name = "rk_valid", schema = "jmdict", catalog = "egd")
public final class RkValid implements Serializable {

    private static final long serialVersionUID = 745465144807408537L;
