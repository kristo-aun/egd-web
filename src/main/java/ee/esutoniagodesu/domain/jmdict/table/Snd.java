...
@Entity
@Immutable
@Table(name = "Snd", schema = "jmdict", catalog = "egd")
public final class Snd implements Serializable {
    ...
    private Collection<Entrsnd> entrsndsById;
    private Collection<Rdngsnd> rdngsndsById;
    private Sndfile sndfileByFile;

    @OneToMany(mappedBy = "sndBySnd")
    public Collection<Entrsnd> getEntrsndsById() {
        return entrsndsById;
    }

    public void setEntrsndsById(Collection<Entrsnd> entrsndsById) {
    ...
    @OneToMany(mappedBy = "sndBySnd")
    public Collection<Rdngsnd> getRdngsndsById() {
        return rdngsndsById;
    }

    public void setRdngsndsById(Collection<Rdngsnd> rdngsndsById) {
    ...
    public Sndfile getSndfileByFile() {
        return sndfileByFile;
    }

    public void setSndfileByFile(Sndfile sndfileByFile) {
