...
@Entity
@Immutable
@Table(name = "sndfile", schema = "jmdict_en", catalog = "egd")
public final class EN_Sndfile implements Serializable {
    ...
    private Collection<EN_Snd> sndsById;
    private EN_Sndvol sndvolByVol;
    ...
    public Collection<EN_Snd> getSndsById() {
        return sndsById;
    }

    public void setSndsById(Collection<EN_Snd> sndsById) {
        this.sndsById = sndsById;
    }

    @ManyToOne
    @JoinColumn(insertable = false, updatable = false, name = "vol", referencedColumnName = "id", nullable = false)
    public EN_Sndvol getSndvolByVol() {
        return sndvolByVol;
    }

    public void setSndvolByVol(EN_Sndvol sndvolByVol) {
    ...
    public boolean equals(Object o) {
        ...
        EN_Sndfile sndfile = (EN_Sndfile) o;
