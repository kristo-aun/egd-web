...
@Entity
@Immutable
@Table(name = "kwsrct", schema = "jmdict_en", catalog = "egd")
public final class EN_Kwsrct implements Serializable {

    private static final long serialVersionUID = -4148845167654975432L;
    private short id;
    private String kw;
    private String descr;
    private Collection<EN_Kwsrc> kwsrcsById;
    ...
    public Collection<EN_Kwsrc> getKwsrcsById() {
        return kwsrcsById;
    }

    public void setKwsrcsById(Collection<EN_Kwsrc> kwsrcsById) {
