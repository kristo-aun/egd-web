...
@Entity
@Immutable
@Table(name = "Kwmisc", schema = "jmdict", catalog = "egd")
public final class Kwmisc implements Serializable {

    private static final long serialVersionUID = 7768936481175252595L;
    private int id;
    private String kw;
    private String descr;
    private Collection<Misc> miscsById;
    ...
    public Collection<Misc> getMiscsById() {
        return miscsById;
    }

    public void setMiscsById(Collection<Misc> miscsById) {
