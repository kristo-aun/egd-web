...
@Entity
@Immutable
@Table(name = "Kwstat", schema = "jmdict", catalog = "egd")
public final class Kwstat implements Serializable {

    private static final long serialVersionUID = -2577388880705170124L;
    private int id;
    private String kw;
    private String descr;
    private Collection<Entr> entrsById;
    private Collection<Hist> histsById;
    ...
    @OneToMany(mappedBy = "kwstatByStat")
    public Collection<Hist> getHistsById() {
        return histsById;
    }

    public void setHistsById(Collection<Hist> histsById) {
