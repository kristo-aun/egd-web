...
public class ReportDB extends AbstractProjectRepository {
    ...
    @Deprecated
    public List<Map<String, ?>> findEstJap(boolean beta) {
        StringBuilder msg = new StringBuilder("findEstJap: beta=" + beta);
    ...
    @Deprecated
    public List<Map<String, ?>> findAllBeta() {
        StringBuilder msg = new StringBuilder("findAllBeta: ");
